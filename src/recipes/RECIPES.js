export const RECIPES = [
  {
    id: 0,
    title: 'Salmon with Lentils and Mustard-Herb Butter (Saumon aux Lentilles)',
    cookTime: '1 hour',
    ingredients: [
    ...
    notes: [
      `'Cooks' notes:'`,
      '·Mustard-herb butter can be made 1 day ahead and chilled, covered. ',
      'Soften at room temperature before using (1 hour).',
  ...
  {
    id: 0,
    title: 'Herb Butter Chicken and Wild Rice'
  }
